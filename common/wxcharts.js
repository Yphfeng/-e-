 ...
 *
 * https://bughub.com/xiaolin3303/wx-charts
 * 2016-11-28
 *
...
function createCurveControlPoints(points, i) {
  ...
  // fix issue https://bughub.com/xiaolin3303/wx-charts/issues/79
...
function getYAxisTextList(series, opts, config) {
  ...
  // fix issue https://bughub.com/xiaolin3303/wx-charts/issues/9
  if (minData === maxData) {
...
function drawPieDataPoints(series, opts, config, context) {
  ...
  if (opts.dataLabel !== false && process === 1) {
    // fix https://bughub.com/xiaolin3303/wx-charts/issues/132
    var valid = false;
...
Charts.prototype.scrollStart = function (e) {
  ...
  if (e.changedTouches[0] && this.opts.enableScroll === true) {
    this.scrollOption.startTouch = e.changedTouches[0];
  }
};
...
Charts.prototype.scroll = function (e) {
  ...
  if (e.changedTouches[0] && this.opts.enableScroll === true) {
    var _distance;
    if (this.opts.enableVertical) {
      _distance = e.changedTouches[0].y - this.scrollOption.startTouch.y;
    } else {
      _distance = e.changedTouches[0].x - this.scrollOption.startTouch.x;
    }
    var currentOffset = this.scrollOption.currentOffset;
